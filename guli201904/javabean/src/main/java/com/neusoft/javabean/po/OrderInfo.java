...
public class OrderInfo implements Serializable {
    ...
    public OrderInfo(Long id, String consignee, String consigneeTel, BigDecimal totalAmount, String orderStatus, Long userId, String paymentWay, String deliveryAddress, String orderComment, String outTradeNo, String tradeBody, Date createTime, Date expireTime, String processStatus, String trackingNo, Long parentOrderId, String imgUrl) {
        this.id = id;
